			...
			<div id="conteneur_2">
				...
				<div id="corps">
					...
					<div id="texte"><div id="overflow">
						...
						愛 Flasque, jaune, endormi, Gudetama est en fait un étrange ouf flemmard inventé l'année dernière et dont le seul but est de ne rien faire de la journée et de se morfondre dans son blanc d'oeuf :D

...
<!--						<div class="bottom_MV"></div>
					...
					<div id="texte"><div id="overflow">
						...
						<h1>ぐでたまショートアニメ 第717話「フラッシュモブ」（2/16放送）</h1>
						<h2>Diffusé le 15/02/2017</h2>
						<h3>Février 2017</h3>
						<table>
							<tr>
								<td>
									<div id="video">
										<video width="640" height="360" controls="controls">
											<source src="C:\Users\Jojo\Downloads\kit graphique(2)\kit graphique\video2.mp4" type="video/mp4" />
										</video>
									</div>
								</td>

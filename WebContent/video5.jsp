...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
	<head>
		<!-- Ce site a Ã©tÃ© crÃ©Ã© avec http://www.creer-son-website.fr/ -->
...
-->				<div id="corps">
					...
					<div id="texte"><div id="overflow">
						...
						<!-- DÃ©but de la zone de texte -->
						<h1>ぐでたまショートアニメ 第721話「飼い主とペット」（2/21放送）</h1>
						<h2>Diffusé le 20/02/2017</h2>
						<h3>Février 2017</h3>
						<table>
							<tr>
								<td>
									<div id="video">
										<video width="640" height="360" controls="controls">
											<source src="C:\Users\Jojo\Downloads\kit graphique(2)\kit graphique\video5.mp4" type="video/mp4" />
										</video>
									</div>
								</td>
